...
export function ExecutiveSummaryPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="page-hero pb-16 md:pb-20">
        <div className="container-anwi">
          <div className="flex flex-wrap items-center gap-3">
            <span className="badge-gold">Executive Summary</span>
            <span className="badge-new">Live Data</span>
          </div>
          <h1 className="hero-title mt-6 max-w-4xl text-4xl md:text-5xl lg:text-[3.25rem]">
            The state of Africa&apos;s next workforce
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/60">
            Live intelligence from {stats.countryCount} pilot countries. Updated for the{' '}
            {brand.edition} from public sources, institutional research, and ANWI proprietary
            analysis.
          </p>
          ...
          {/* Hero stats */}
          <div className="mt-16 grid grid-cols-2 gap-6 border-t border-white/10 pt-10 md:grid-cols-3 lg:grid-cols-6 md:gap-8">
            {[
