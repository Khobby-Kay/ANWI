export const brand = {
  indexName: 'Africa Next Workforce Index',
  shortName: 'ANWI',
  tagline: 'Measuring how well African nations convert youth into performance in an AI-shaped economy.',
  version: '0.1',
  edition: 'Pilot Edition 2026',
